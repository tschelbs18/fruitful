...
urlpatterns = [
  ...
  path("redeem_standard_reward/<int:reward_id>/", views.redeem_standard_reward, name="redeem_standard_reward"),
  path("past_rewards", views.past_rewards_view, name="past_rewards"),
